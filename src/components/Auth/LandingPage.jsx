...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-valhalla-parchment dark:bg-valhalla-void transition-colors duration-500">
      
      {/* Decorative background elements */}
      <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-valhalla-gold/10 dark:bg-valhalla-neon/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-amber-500/10 dark:bg-purple-500/10 rounded-full blur-3xl"></div>
      ...
      <div className="relative z-10 glass max-w-md w-full p-10 rounded-2xl text-center shadow-2xl border-valhalla-gold/30 dark:border-valhalla-neon/30">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg font-medium text-valhalla-ink/70 dark:text-gray-400 tracking-widest uppercase text-sm mt-4">
            Coordinate. Conquer.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          {error && (
            <div className="bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 p-3 rounded-lg text-sm border border-red-200 dark:border-red-800">
              {error}
            </div>
          )}
          ...
          >
            {loading ? (
              <span className="animate-pulse">Opening the Gates...</span>
            ) : (
              <>
